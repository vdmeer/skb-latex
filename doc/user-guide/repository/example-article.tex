...
The article uses the class \skbem[code]{skbarticle}. That class will load the \skbacft{vdm:skb} package and
...
describes the protocols \ac{org:omg:giop} defined by the \ac{org:omg}, \ac{org:ietf:snmp} by the
\ac{org:ietf}, \ac{org:itu:x700:cmip} by the \ac{org:itu} and finally \ac{org:ietf:www:http} by the 
\ac{org:w3c}.
