...
\begin{skbnotelist}
  ...
  \item The documents are written in all sorts of formats or available only in (usually proprietary) binary
        formats. Ever tried to open a document written in \skbacft{com:us:ms} WinWord 6.0 with customised document
  ...
  \item Reusing the ideas/concepts, once found in a document and managed to open that very document,
        ...
        use a {\scshape Bib}\TeX) generated reference list, found in a \skbacft{org:iso:pdf} file in a new article?
