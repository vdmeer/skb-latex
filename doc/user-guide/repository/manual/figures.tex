...
The classic way to add figures to your document is to have a \skbacft{org:iso:pdf} or \skbacft{org:ietf:png} or \skbacft{org:iso:jpg} 
...
With the \skbacft{vdm:skb} macro \cmd{\skbfigure} things become a little bit simplier.
