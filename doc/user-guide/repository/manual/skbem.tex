...
highlighted text. A simple start is provided by the \skbacft{vdm:skb}. It is simply because, at the moment, it 
...
Last not least, the option \skbem[code]{code} will use another \skbacft{vdm:skb} macro (\cmd{\skbcode}) for typesetting
