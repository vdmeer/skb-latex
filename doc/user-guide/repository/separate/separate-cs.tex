...
heading with the \skbacft{vdm:skb} macro \cmd{\setheading}. This allows to select the appropriate
...
respective \ac{misc:sdo} acronyms, such as \skbem[code]{omg} for the \skbacft{org:omg} and 
\skbem[code]{ieee} for the \skbacft{org:ieee} and \skbem[code]{ietf} for the
\skbacft{org:ietf}. We put all this in a folder named repository, making it explicit
