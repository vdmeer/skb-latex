...
There are two ways to install the \skbacft{vdm:skb}. The first option is have it 
automatically installed by your \LaTeX~distribution using \TeX Life 
or the \skbacft{org:ctan} archive\footnote{Note: Version 0.5 of the \skbacft{vdm:skb} has been submitted
to \skbacft{org:ctan} and is available at http://www.ctan.org/tex-archive/macros/latex/contrib/skb/.
...
\noindent And now the source files of the \skbacft{vdm:skb}:
\begin{skbnoteenum}
...
Now you have installed the \skbacft{vdm:skb} and you are ready to use it.