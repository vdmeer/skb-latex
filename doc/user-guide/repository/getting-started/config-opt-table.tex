      \skbem[code]{root}    & Sets the root path of the SKB. Everything that the \ac{vdm:skb}
    ...
    \midrule
      \skbem[code]{acr},
      \skbem[code]{acrfile} & The \ac{vdm:skb} uses the \skbem[code]{acronym} package and these two macros
